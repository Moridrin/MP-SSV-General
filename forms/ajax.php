...
function mp_general_forms_save_field()
{
...
add_action('wp_ajax_mp_general_forms_save_field', 'mp_general_forms_save_field', 10, 0);

function mp_general_forms_delete_field()
{
    $id     = BaseFunctions::sanitize($_POST['id'], 'int');
    $shared = BaseFunctions::sanitize($_POST['shared'], 'bool');
    $formId = BaseFunctions::sanitize($_POST['formId'], 'int');
...
add_action('wp_ajax_mp_general_forms_delete_field', 'mp_general_forms_delete_field');

function mp_general_forms_delete_form()
{
    $id = BaseFunctions::sanitize($_POST['id'], 'int');
    Form::deleteByIds([$id]);
    wp_die();
...
add_action('wp_ajax_mp_general_forms_delete_form', 'mp_general_forms_delete_form');

function mp_general_forms_delete_forms()
{
    Form::deleteByIds(BaseFunctions::sanitize($_POST['formIds'], 'int'));
}

add_action('wp_ajax_mp_general_forms_delete_forms', 'mp_general_forms_delete_forms');
